    ...
    TimeAdapter = /** @class */ (function () {
         ...
         */
            function (time, format) {
                ...
                return luxon.DateTime.fromFormat(this.parseTime(time), 'h:m a').toFormat(timeFormat).toLowerCase();
            };
        /**
         * @param {?} time
         * @return {?}
         ...
         */
            function (time) {
                return luxon.DateTime.fromFormat(this.parseTime(time), 'h:m a');
            };
        /**
         * @param {?} time
         * @param {?=} min
        ...
        Object.defineProperty(NgxMaterialTimepickerService.prototype, "defaultTime", {
             ...
             */ function (time) {
                ...
                if (luxon.DateTime.fromJSDate(defaultTime).isValid) {
                    ...
                    this.hour = __assign({}, DEFAULT_HOUR, { time: period === TimePeriod.PM ? defaultTime.getHours() - 12 : defaultTime.getHours() });
